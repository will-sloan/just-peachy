"""Root-admitted fresh restore with OS listener evidence; see README_S6D_CLOSED_TELEMETRY_RESTORE_V3.md."""
...
REVIEW_STATUS='ROOT_ACCEPTED_TELEMETRY_RECOVERY_V2_SOURCES_V3'
