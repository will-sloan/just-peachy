...
`s6c_n00_review.py` reads completed, immutable N00 core tables and eight
...
Outputs in a fresh `independent_review/n00_screen_v1` directory are profile and
...
& 'C:\Users\amiri\anaconda3\python.exe' s6c_n00_review.py --output-subdir independent_review/n00_screen_v1
```
