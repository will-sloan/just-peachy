"""Tiny serial long admission/closure guards; README_S6C_LONG_DISPATCH_V1.md."""
from __future__ import annotations
import argparse,ast,copy,json,tempfile,types
from pathlib import Path
from unittest.mock import patch
import s6c_long_dispatch_v1 as L
...
def run(output):
 ...
 class Reverse(ast.NodeTransformer):
  def visit_Constant(self,n):
   v={'serial_long_dispatcher':'serial_paced_dispatcher','README_S6C_LONG_DISPATCH_V1.md':'README_S6C_PACED_DISPATCH_V3.md','s6c-serial-long-dispatch-result.v1':'s6c-serial-paced-dispatch-result.v1'}
