"""Exact registered cross-route paced option; README_S6C_PACED_CROSS_ROUTES_FAST_V2.md."""
...
PINS={'s6c_paced_epoch4_fast_v2.py':'a8776724003fa2a642575892327b7c3e88eaddf29606881b302b05157c12b270',
...
C=importlib.import_module('s6c_paced_epoch4_fast_v2');D=importlib.import_module('s6c_long_b36_v1')
for module in (C,D):
...
def source_bindings():
    own=[L.bind(Path(__file__)),L.bind(HERE/'README_S6C_PACED_CROSS_ROUTES_FAST_V2.md'),L.bind(HERE/'s6c_long_b36_v1.py'),L.bind(HERE/'README_S6C_LONG_B36_V1.md')]
...
def compile_adapter():
    tree=ast.parse((HERE/'s6c_paced_epoch4_fast_v2.py').read_bytes());nodes=[];edits=[];originals={}
    class Metadata(ast.NodeTransformer):
        ...
        def visit_Compare(self,node):
            if ast.unparse(node)=="'s6c_paced_epoch4.py' in names":
                ...
                return ast.copy_location(ast.parse("bool({'s6c_paced_epoch4.py','s6c_paced_arrival_sentinel_v1.py','s6c_paced_cross_routes_v1.py','s6c_paced_epoch4_fast_v1.py','s6c_paced_arrival_sentinel_fast_v1.py','s6c_paced_cross_routes_fast_v1.py','s6c_paced_epoch4_fast_v2.py','s6c_paced_arrival_sentinel_fast_v2.py','s6c_paced_cross_routes_fast_v2.py'} & names)",mode='eval').body,node)
