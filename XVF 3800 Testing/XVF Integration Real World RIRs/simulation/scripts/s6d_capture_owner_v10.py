"""V10 adds recorded-terminal recovery admission; README_S6D_CAPTURE_V10.md. No import-time I/O."""
...
def validate_plan(plan_path,authorization=None):
    ...
    if authorization is not None:
        ...
        required=[Path(__file__),SIM/'scripts/README_S6D_CAPTURE_V10.md',SIM/'scripts/README_S6D_CAPTURE_V5.md',SIM/'scripts/s6d_restoration_policy_v1.py',SIM/'scripts/s6d_capture_transport.py',SIM/'scripts/s6d_telemetry_v2.py',
