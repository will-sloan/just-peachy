"""Canonical paired paced adapter; see README_S6C_PACED_EPOCH4_FAST_V2.md."""
...
def namespace_roots(namespace):
    if not re.fullmatch(r'[A-Za-z0-9_-]{1,60}',namespace) or not namespace.endswith('_fast_v2'):raise ValueError('Simple fresh paced namespace required')
...
def source_checks():
    ...
    return common.save(REPORT/'paced_candidates/observer_fast_v2/SOURCE_CHECKS_V1.json',result,immutable=True)
