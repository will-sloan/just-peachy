...
& '.\.edge-speech-env\python.exe' "$sim\scripts\s6c_native_replay.py" --epoch epoch1 --results "$sim\reports\S6C\20260910T123540Z\jobs\epoch1\smoke_v1_RESULTS.json" --label smoke_v1
```
