"""Serial original paced runners; README_S6C_PACED_DISPATCH_V3.md."""
...
def run(args):
 ...
 save(out/'ADMISSION.json',dict(status='DISPATCHER_STARTED',owner=owner,queue=qb,authority=ab,source=binding(__file__),readme=binding(HERE/'README_S6C_PACED_DISPATCH_V3.md'),created_utc=utc()))
