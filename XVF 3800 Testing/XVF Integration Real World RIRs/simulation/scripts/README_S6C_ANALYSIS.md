...
& '..\staging\s5_text_metrics\analysis_env\Scripts\python.exe' s6c_analysis.py --test
& '..\staging\s5_text_metrics\analysis_env\Scripts\python.exe' s6c_analysis.py --index 'epoch1\CHALLENGE_N00_PREDICTION_INDEX.json' --output-subdir 'n00_challenge_core_v1' --require-complete
```
