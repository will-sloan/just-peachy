...
& '.\.edge-speech-env\python.exe' "$sim\scripts\s6c_policy_matrix.py" --epoch epoch1 --indices "$r\jobs\epoch1\recipes_v1_RESULTS.json" "$r\jobs\epoch1\split_v1_RESULTS.json" --label component_panel_v1 --candidates C065 C066 C067 C068 C069 C070 C071 C072 C073 C074 C075 C076 C077 C078 C079 C080 C081 C082 C083 C084 C085 C086
```
