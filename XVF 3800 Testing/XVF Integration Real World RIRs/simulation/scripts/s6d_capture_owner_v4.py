"""V4 explicit in-memory stop hook; README_S6D_CAPTURE_V4.md. No import-time I/O."""
...
def validate_plan(plan_path,authorization=None):
    ...
    if authorization is not None:
        ...
        required=[Path(__file__),SIM/'scripts/README_S6D_CAPTURE_V4.md',SIM/'scripts/s6d_capture_transport.py',SIM/'scripts/s6d_telemetry.py',
