"""Five exact prepared continuous sessions; README_S6C_LONG_DISPATCH_V1.md."""
...
def sources():
 ...
 rows.extend(D.binding(HERE/name) for name in ('README_S6C_PACED_DISPATCH_V3.md','README_S6C_LONG_NATIVE_EPOCH4_FAST_V2.md','README_S6C_LONG_B36_FAST_V1.md','README_S6C_LONG_B36_V1.md','README_S6C_HISTORICAL_FAST_OBSERVER_V1.md','s6c_long_dispatch_v1.py','README_S6C_LONG_DISPATCH_V1.md'))
 return rows
...
def execution_context():
 ...
 class Delta(ast.NodeTransformer):
  def visit_Constant(self,n):
   values={'serial_paced_dispatcher':'serial_long_dispatcher','README_S6C_PACED_DISPATCH_V3.md':'README_S6C_LONG_DISPATCH_V1.md','s6c-serial-paced-dispatch-result.v1':'s6c-serial-long-dispatch-result.v1'}
