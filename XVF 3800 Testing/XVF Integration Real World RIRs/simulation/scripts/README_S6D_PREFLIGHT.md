...
& 'C:\Users\amiri\anaconda3\python.exe' "$s6dSim\scripts\s6d_preflight_v1.py" --report "$s6dSim\reports\S6D\20260913T195357Z\preflight_v1"
```

Anaconda Prompt / CMD:
```bat
set "S6D_SIM=C:\Users\amiri\Documents\GitHub\just-peachy\XVF 3800 Testing\XVF Integration Real World RIRs\simulation"
"C:\Users\amiri\anaconda3\python.exe" "%S6D_SIM%\scripts\s6d_preflight_v1.py" --report "%S6D_SIM%\reports\S6D\20260913T195357Z\preflight_v1"
```
