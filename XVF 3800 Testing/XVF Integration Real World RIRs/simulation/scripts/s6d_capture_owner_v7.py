"""V7 cooperative telemetry and separately reviewed fresh restoration; README_S6D_CAPTURE_V7.md. No import-time I/O."""
...
def validate_plan(plan_path,authorization=None):
    ...
    if authorization is not None:
        ...
        required=[Path(__file__),SIM/'scripts/README_S6D_CAPTURE_V7.md',SIM/'scripts/README_S6D_CAPTURE_V5.md',SIM/'scripts/s6d_restoration_policy_v1.py',SIM/'scripts/s6d_capture_transport.py',SIM/'scripts/s6d_telemetry_v2.py',
            SIM/'scripts/README_S6D_TELEMETRY_V2.md',SIM/'scripts/s6d_closed_telemetry_restore_v2.py',SIM/'scripts/README_S6D_CLOSED_TELEMETRY_RESTORE_V2.md',
...
def recorder_port_preflight(batch_dir,provider):
    ...
    from s6d_closed_telemetry_restore_v2 import tcp_census,tcp_listener_decision
    ...
    for acquired in (report/'hardware_batches').glob('*/owner_acquired.json'):
        ...
        if not valid:
            ...
            if recovery.get('schema_version')=='edge-s6d-restoration-recovery.v2':
                ...
                from s6d_closed_telemetry_restore_v2 import verify_recovery_record
