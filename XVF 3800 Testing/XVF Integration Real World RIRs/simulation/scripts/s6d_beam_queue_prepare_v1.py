"""Write held literal beam-stage queue only; see README_S6D_BEAM_QUEUE_PREPARE_V1.md."""
import argparse
...
def prepare(manifest_path,manifest_sha,output):
    ...
    N.need(m['schema']=='s6d-beam-execution.v1' and m['jobs'],'Bound nonempty native stage required')
