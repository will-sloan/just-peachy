...
& 'C:\Users\amiri\anaconda3\python.exe' -B "$taskSim\scripts\s6d_native_remaining_prepare_v1.py" --output "$taskSim\reports\S6D\20260913T195357Z\runner\native_remaining892_preparation_v1" --payload 'G:\Just_Peachy_S6D\20260913T195357Z\runner\native_remaining892_preparation_v1'
```
...
"C:\Users\amiri\anaconda3\python.exe" -B "%TASK_SIM%\scripts\s6d_native_remaining_prepare_v1.py" --output "%TASK_SIM%\reports\S6D\20260913T195357Z\runner\native_remaining892_preparation_v1" --payload "G:\Just_Peachy_S6D\20260913T195357Z\runner\native_remaining892_preparation_v1"
```
...
$taskPlan=Get-Content -Raw -LiteralPath "$taskR\runner\native_remaining892_preparation_v1\PREPARATION_RESULT.json" | ConvertFrom-Json
