"""V5 guarded adaptive-state restoration; README_S6D_CAPTURE_V5.md. No import-time I/O."""
...
def validate_plan(plan_path,authorization=None):
    ...
    if authorization is not None:
        ...
        required=[Path(__file__),SIM/'scripts/README_S6D_CAPTURE_V5.md',SIM/'scripts/s6d_restoration_policy_v1.py',SIM/'scripts/s6d_capture_transport.py',SIM/'scripts/s6d_telemetry.py',
