"""N6h closure JSON-wire repair proposal. See README_S6D_BEAM_NATIVE_N6H.md."""
...
PINS={'protocol':'874d55b0449f5cb53d9b6bf476d7a8cf97d1022e1cffd5ef844f71af5f8c5084',
      ...
      'beam':'82a95a4b352346db06983756dbc07cad904b9041ca349938eda9f3f4f907047d'}
...
def closure_wire(value):
    """Compare full JSON receipts across tuple/list serialization; no value coercion."""
...
def validate_multistream(result,job,finalization,closure,journals,dispatch):
    ...
    check((queues.get('event_consumer') or {}).get('depth')==0 and closure.get('full_event_consumer_drained') is True and closure_wire(closure.get('queues'))==closure_wire(queues),'Consumer closure absent')
