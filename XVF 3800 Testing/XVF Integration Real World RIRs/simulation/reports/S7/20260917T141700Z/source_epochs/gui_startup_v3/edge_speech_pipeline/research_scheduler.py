    ...
    def _asr(self, event):
        ...
        if record is None:
            ...
            changes.append(self._record("transcript_label_revision", event, {"utterance_id": key,
                ...
                "replacement_tracker_id": decision.get("tracker_id", decision.get("cluster_id")) if decision else None,
                "target_source_start_sec": event["source_start_sec"], "target_source_end_sec": event["source_end_sec"],
        ...
        record.update(source_end_sec=event["source_end_sec"], text=event["text"], text_revision_id=event["event_id"],
                      display_text=event.get("display_text", event["text"]),
