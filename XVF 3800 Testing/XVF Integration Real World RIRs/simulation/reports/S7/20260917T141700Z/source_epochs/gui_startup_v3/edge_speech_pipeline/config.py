...
class PipelineConfig:
    ...
    # Explicit S6 research controls; historical behavior remains the default.
    asr_decoding_method: str = "greedy_search"
    asr_max_active_paths: int = 4
    asr_blank_penalty: float = 0.0
    segmentation_post_policy: str = "hard_argmax_fraction"
    segmentation_speech_fraction_threshold: float = 0.20
    segmentation_overlap_fraction_threshold: float = 0.20
    input_gain: float = 1.0
    partial_display_min_interval_sec: float = 0.0
    # An explicit S6D settings file enables delivery/presentation research only.
    s6d_settings_path: Path | None = None
