...
#define configNUM_CORES                         appconfNUM_FREE_RTOS_CORES //See app_conf.h
...
#define configTASK_NOTIFICATION_ARRAY_ENTRIES   3 // This is determined GPIO_NUM_IMPORT_PORTS + 1 currently - see io_config_servicer.c
...
#define configTOTAL_HEAP_SIZE                   appconfTOTAL_HEAP_SIZE
