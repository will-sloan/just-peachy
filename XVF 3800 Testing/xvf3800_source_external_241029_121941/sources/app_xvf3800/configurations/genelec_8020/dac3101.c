...
int dac3101_init(uint32_t sample_rate)
{
	...
	if (
        ...
        // LDAC routed to left channel mixer amp, RDAC not routed
        // HPL routed to HPR for differential output
        dac3101_reg_write(DAC3101_DAC_OP_MIX, 0x41) == 0 &&
        ...
        // Enable HPL output analog volume, set = -10.5 dB
        dac3101_reg_write(DAC3101_HPL_VOL_A, 0x95) == 0 &&
        // Enable HPR output analog volume, set = -10.5 dB
        dac3101_reg_write(DAC3101_HPR_VOL_A, 0x95) == 0 &&
        ...
        dac3101_reg_write(DAC3101_L_BQD_A_N1_LO, 0xC4) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_A_N2_HI, 0x7A) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_A_N2_LO, 0x9A) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_A_D1_HI, 0x7B) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_A_D1_LO, 0x14) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_A_D2_HI, 0x89) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_A_D2_LO, 0x6F) == 0 &&
        ...
        dac3101_reg_write(DAC3101_R_BQD_A_N1_LO, 0xC4) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_A_N2_HI, 0x7A) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_A_N2_LO, 0x9A) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_A_D1_HI, 0x7B) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_A_D1_LO, 0x14) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_A_D2_HI, 0x89) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_A_D2_LO, 0x6F) == 0 &&
        ...
        dac3101_reg_write(DAC3101_L_BQD_B_N1_HI, 0x80) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_B_N1_LO, 0x01) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_B_N2_HI, 0x7F) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_B_N2_LO, 0xFF) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_B_D1_HI, 0x7E) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_B_D1_LO, 0x38) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_B_D2_HI, 0x83) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_B_D2_LO, 0x83) == 0 &&
        ...
        dac3101_reg_write(DAC3101_R_BQD_B_N1_HI, 0x80) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_B_N1_LO, 0x01) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_B_N2_HI, 0x7F) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_B_N2_LO, 0xFF) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_B_D1_HI, 0x7E) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_B_D1_LO, 0x38) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_B_D2_HI, 0x83) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_B_D2_LO, 0x83) == 0 &&
        ...
        dac3101_reg_write(DAC3101_L_BQD_C_N1_HI, 0x80) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_C_N1_LO, 0x01) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_C_N2_HI, 0x7F) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_C_N2_LO, 0xFF) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_C_D1_HI, 0x7E) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_C_D1_LO, 0x38) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_C_D2_HI, 0x83) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_C_D2_LO, 0x83) == 0 &&
        ...
        dac3101_reg_write(DAC3101_R_BQD_C_N1_HI, 0x80) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_C_N1_LO, 0x01) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_C_N2_HI, 0x7F) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_C_N2_LO, 0xFF) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_C_D1_HI, 0x7E) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_C_D1_LO, 0x38) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_C_D2_HI, 0x83) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_C_D2_LO, 0x83) == 0
    ) {
		// Wait for 100 ms
        dac3101_wait(100);
	} else {
	...
	if (
        ...
        // Powerup DAC left channel (soft step enabled)
        // DACL = L only, right channel not on
        dac3101_reg_write(DAC3101_DAC_DAT_PATH,0x90) == 0 &&
        // DAC Left gain = 0dB
