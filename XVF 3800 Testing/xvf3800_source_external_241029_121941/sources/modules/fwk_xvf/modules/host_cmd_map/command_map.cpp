...
#include "transport_config.h" // Autogenerated, has I2C_ADDRESS and SPI_MODE

static int i2c_info = I2C_ADDRESS;    // I2C slave address
...
// TODO Remove this #define and the pre-processor conditional below and
// all of the #else clause as part of completing fwk_xvf issue 91.
#define PER_SAMPLE_RATE_PID_ENHANCEMENT (1)

#if PER_SAMPLE_RATE_PID_ENHANCEMENT
static int usb_info[10] = {
    3,                    // number of VID-PID-IF triples to follow
    VENDOR_ID,            // vendor ID for 48 kHz build config
    PRODUCT_ID_IO_48KHZ,  // product ID for 48 kHz build config
    3,                    // control interface number for 48 kHz build config
    VENDOR_ID,            // vendor ID for 32 kHz build config
    PRODUCT_ID_IO_32KHZ,  // product ID for 32 kHz build config
    3,                     // control interface number for 32 kHz build config
    VENDOR_ID,            // vendor ID for 16 kHz build config
    PRODUCT_ID_IO_16KHZ,  // product ID for 16 kHz build config
    3                     // control interface number for 16 kHz build config
};
...
#include "super_print_arg.h" // Autogenerated super print functions

#include "range_check.h" // Autogenerated range functions
