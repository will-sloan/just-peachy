...
// This value was chosen as the most reliable one during extensive testing.
// Increasing this value causes the download operation to fail due to LIBUSB_ERROR_PIPE on Windows.
// Reducing this value may cause the download operation to fail, because it is too short for the flash driver to erase and write the data.
#define DOWNLOAD_TIMEOUT_MS 12

// Define the amount of time to wait to allow the intertile context to clear
#define DOWNLOAD_RPC_INTERFACE_DELAY_MS 4
