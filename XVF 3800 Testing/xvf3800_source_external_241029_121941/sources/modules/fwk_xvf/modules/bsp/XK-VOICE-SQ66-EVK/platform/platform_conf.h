...
#endif
// There's only one logical core for RTOS on tile 1, so
#define appconfXUD_IO_CORE                      0
#define appconfUSB_SOF_INTERRUPT_CORE           0
#define appconfUSB_INTERRUPT_CORE               0
...
#ifndef appconfFLASH_RPC_PORT
#define appconfFLASH_RPC_PORT 14
#endif /* appconfFLASH_RPC_PORT */

#ifndef appconfFLASH_RPC_PRIORITY
#define appconfFLASH_RPC_PRIORITY (configMAX_PRIORITIES/2)
#endif /* appconfFLASH_RPC_PRIORITY */
