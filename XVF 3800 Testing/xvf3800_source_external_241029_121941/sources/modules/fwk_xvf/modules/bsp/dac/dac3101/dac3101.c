...
int dac3101_init(uint32_t sample_rate)
{
	...
	if (
        ...
        dac3101_reg_write(DAC3101_L_BQD_A_N1_HI, 0x00) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_A_N1_LO, 0x00) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_A_N2_HI, 0x00) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_A_N2_LO, 0x00) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_A_D1_HI, 0x00) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_A_D1_LO, 0x00) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_A_D2_HI, 0x00) == 0 &&
        dac3101_reg_write(DAC3101_L_BQD_A_D2_LO, 0x00) == 0 &&
        ...
        dac3101_reg_write(DAC3101_R_BQD_A_N1_HI, 0x00) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_A_N1_LO, 0x00) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_A_N2_HI, 0x00) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_A_N2_LO, 0x00) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_A_D1_HI, 0x00) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_A_D1_LO, 0x00) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_A_D2_HI, 0x00) == 0 &&
        dac3101_reg_write(DAC3101_R_BQD_A_D2_LO, 0x00) == 0 &&
