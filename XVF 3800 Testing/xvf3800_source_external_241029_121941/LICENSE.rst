...
Source Terms. Such actions shall include:
   ...
   (i) combining the Software (in whole or in part) or any derivative work
       thereof with any Open Source Software, by means of incorporation or
       linking or otherwise; and

   (ii) using Open Source Software to create a derivative work of the Software (including any part of the Software);
...
sub-licence the Software on a standalone basis. You shall be
...
Open-source software included in the Software Release package is not Licenced
under the terms of this Agreement, but is instead Licensed under the
terms of the applicable open-source Licences which are included in the
individual directories or software source files in the package.

6.  **Regulatory Compliance and Instructions.** Licensee understands
...
7.  **Warranties & Disclaimers.** To the maximum extent permitted by
...
9.  **High Risk Activities.** The Software is not designed or intended for
...
10.  **Export**. Licensee shall use the Software in accordance with
...
to the granting of an export or import licence or end-use statement
...
11. **Termination.** XMOS may terminate this Agreement (including for
...
12. **General.** In the event of conflict, the terms of this Agreement
