...
- Run id: `m9_speechbrain_cached_smoke_runner`
...
- `python scripts/embed_speaker_folder.py m9_test/audio --backend speechbrain --output m9_test/smoke/speechbrain_cached_embeddings.jsonl --report m9_test/smoke/speechbrain_cached_report.md --dimension 16 --min-duration-sec 0.1 --labels-csv m9_test/labels.csv --run-id m9_speechbrain_cached_smoke_runner`

## Validation Checks

- Dimension checks: successful dimensions=[192]
- Normalization checks: min_norm=1.0000, max_norm=1.0000
- Serialization checks: wrote 3 row(s) to m9_test/smoke/speechbrain_cached_embeddings.jsonl
- Runtime RTF: mean=0.0061, max=0.0071
- Memory: max_cpu_memory_mb=2403.98
