...
- Run id: `speaker_protocol_enroll_rxr`
...
- `python scripts/enroll_speaker.py --display-name 'rxr' --model-id speechbrain_ecapa --backend speechbrain --audio C:\Users\amiri\Documents\GitHub\just-peachy\Software Validation from Datasets\Raw Datasets (Not formatted)\CMU Arctic\cmu_us_rxr_arctic\wav\arctic_a0400.wav C:\Users\amiri\Documents\GitHub\just-peachy\Software Validation from Datasets\Raw Datasets (Not formatted)\CMU Arctic\cmu_us_rxr_arctic\wav\arctic_a0030.wav C:\Users\amiri\Documents\GitHub\just-peachy\Software Validation from Datasets\Raw Datasets (Not formatted)\CMU Arctic\cmu_us_rxr_arctic\wav\arctic_a0376.wav C:\Users\amiri\Documents\GitHub\just-peachy\Software Validation from Datasets\Raw Datasets (Not formatted)\CMU Arctic\cmu_us_rxr_arctic\wav\arctic_a0484.wav C:\Users\amiri\Documents\GitHub\just-peachy\Software Validation from Datasets\Raw Datasets (Not formatted)\CMU Arctic\cmu_us_rxr_arctic\wav\arctic_a0397.wav --db artifacts\speaker_protocol\cmu_arctic_seed3800_v1\enrollment_db_speechbrain_ecapa.json --run-id speaker_protocol_enroll_rxr --report artifacts\speaker_protocol\cmu_arctic_seed3800_v1\enrollment_reports\rxr.md --prompt-id cmu_arctic_seed3800_v1`
...
- `jmk`: exemplars=5, valid=5, duration_sec=18.285, model_ids=['speechbrain_ecapa'], complete=True
- `ksp`: exemplars=5, valid=5, duration_sec=14.915, model_ids=['speechbrain_ecapa'], complete=True
- `lnh`: exemplars=5, valid=5, duration_sec=13.900, model_ids=['speechbrain_ecapa'], complete=True
- `rms`: exemplars=5, valid=5, duration_sec=17.675, model_ids=['speechbrain_ecapa'], complete=True
- `rxr`: exemplars=5, valid=5, duration_sec=14.838, model_ids=['speechbrain_ecapa'], complete=True
