...
- [Launch control sheet](launch_control_sheet.md): actual campaign hash,
  ...
  `NOT_READY_TO_LAUNCH`.
- [Machine A CUDA qualification](gpu_qualification_report.md): measured GPU,
  VRAM, CPU/CUDA float32/float16 comparison, and operational dtype decision.
