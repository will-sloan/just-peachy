...
if (-not $Destination) {
    $Destination = Join-Path $context.RepositoryRoot "transfer_packages\campaign_05_massive_release\machine_a"
}
...
Write-Host "Validated Machine A transfer: $Destination"
