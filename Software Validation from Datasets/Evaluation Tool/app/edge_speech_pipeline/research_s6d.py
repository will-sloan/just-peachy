...
def build_s6d_scheduler(profile, gallery, provider, emit, settings):
    ...
    s = profile.scheduler
    policy = BoundedRevisionScheduler(S6CTracker(profile.tracker), ResearchIdentityResolver(profile.identity, gallery),
