...
- Run id: `cmu_aew_speechbrain_ecapa_enrollment`
...
- `Alice`: exemplars=5, valid=5, duration_sec=12.955, model_ids=['speechbrain_ecapa'], complete=True
