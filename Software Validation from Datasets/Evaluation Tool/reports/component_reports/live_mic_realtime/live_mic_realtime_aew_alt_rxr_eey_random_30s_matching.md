...
- Date: `2026-07-18T21:13:41.918711+00:00`
- Config path: `C:\Users\will5\Documents\just-peachy\Software Validation from Datasets\Evaluation Tool\configs\inference\live_mic_realtime_whisper_base_speaker_matching.yaml`
- Run directory: `C:\Users\will5\Documents\just-peachy\Software Validation from Datasets\Evaluation Tool\runs\live_mic_realtime\aew_alt_rxr_eey_random_30s_matching`
...
- Whisper model asset: `C:\Users\will5\Documents\just-peachy\models\cache\whisper\base.pt`.
...
- Predictions written: `9`.
- Dropped windows: `1`.
- Latency seconds: `{'count': 9, 'min': 0.5, 'mean': 5.905889, 'max': 17.312}`.
- ASR realtime factor: `{'count': 9, 'min': 0.133146, 'mean': 0.179646, 'max': 0.36632}`.
- Queue metrics: `{'max_depth_observed': 4, 'max_depth_recorded': 4.0, 'dropped_window_count': 1, 'dropped_window_indices': [2]}`.
...
## Output Artifacts
- Predictions: `C:\Users\will5\Documents\just-peachy\Software Validation from Datasets\Evaluation Tool\runs\live_mic_realtime\aew_alt_rxr_eey_random_30s_matching\predictions\utterances.jsonl`
- Diagnostics: `C:\Users\will5\Documents\just-peachy\Software Validation from Datasets\Evaluation Tool\runs\live_mic_realtime\aew_alt_rxr_eey_random_30s_matching\predictions\diagnostics.jsonl`
- Summary: `C:\Users\will5\Documents\just-peachy\Software Validation from Datasets\Evaluation Tool\runs\live_mic_realtime\aew_alt_rxr_eey_random_30s_matching\summary.json`
