...
Purpose: `private_application_process.py` starts a bound Python child suspended
...
`probe_private_application_process.py` is the runnable entry point. It pins the
...
& $jpPython -B "$jpCode\probe_private_application_process.py" --output 'G:\Just_Peachy_N1\20260924_campaign\local\n4\private-process-probe-v1'
```
...
"%JP_PY%" -B "%JP_CODE%\probe_private_application_process.py" --output "G:\Just_Peachy_N1\20260924_campaign\local\n4\private-process-probe-v1"
```
