"""Model-free qualification, including actual Controller consumption. See README_PACED_ADAPTERS_V2.md."""
...
from paced_adapters_v2 import ConsumerSourceClock, PacedResearchPeople
...
class PacedAdapterTests(unittest.TestCase):
    ...
    def test_all_saved_catalog_galleries_preserve_scores_and_routes(self):
        ...
        from paced_adapters_v2 import CountedBaselineGallery
        checked = []
    ...
    def test_actual_controller_consumes_source_event_for_all_three_engine_classes(self):
        ...
        for kind, cls in [('PrototypeEngine', PrototypeEngine), ('N2Engine', N2Engine), ('N3IdentityEngine', N3IdentityEngine)]:
            ...
            try:
                ...
                source_payload = {k:v for k,v in e.payload.items() if not k.startswith('publication_') and k!='session_id'}
