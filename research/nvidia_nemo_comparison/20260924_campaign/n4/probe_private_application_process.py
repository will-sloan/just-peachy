...
import test_private_application_process as regression
...
def run(output):
    ...
    with writer_lock(local/'n4/metric-scoring.owner.lock'):
        ...
        code = [bind(here/name) for name in ('private_application_process.py', 'private_process_fixture.py',
            'test_private_application_process.py', 'probe_private_application_process.py', 'README_PRIVATE_APPLICATION_PROCESS.md',
