"""Research roster and consumer clock instrumentation. README_PACED_ADAPTERS_V2.md."""
...
class ConsumerSourceClock:
    ...
    def _observe(self, engine, event, receipt):
        with self.lock:
            ...
            if (type(sequence) is not int or sequence != self.last_publication_sequence + 1
