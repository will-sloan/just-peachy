"""Bounded closure qualification without source/model launch. README_APPLICATION_CLOSURE_V2.md."""
import argparse
...
def run(args):
    ...
    code=[bind(here/n) for n in ('application_closure.py','test_application_closure.py','application_closure_v2.py','test_application_closure_v2.py','probe_application_closure_v2.py',
        'README_APPLICATION_CLOSURE_V2.md','common.py','metric_process.py','controller_projection.py','asr_full_bank.py','probe_integrated_scoring.py')]
    ...
    freeze(args.output/'ADMISSION.json',dict(owner=identity(process),source=source_binding,code=code,
        accepted_metrics=metrics_binding,historical_reports=parents,cases=cases,private_inventory=inventory,expected_tests=9,
    ...
    import test_application_closure_v2 as tests
