"""Model-free saved-viewport ledger qualification. README_VIEWPORT_LEDGER_V2.md."""
import argparse
...
def run(args):
    ...
    code = [bind(here/n) for n in ('viewport_ledger_v2.py','test_viewport_ledger_v2.py','probe_viewport_ledger_v2.py',
        'README_VIEWPORT_LEDGER_V2.md','widget_visibility.py','common.py','metric_process.py','probe_integrated_scoring.py')]
    ...
    import test_viewport_ledger_v2 as tests
