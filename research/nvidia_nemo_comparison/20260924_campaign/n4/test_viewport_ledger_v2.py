"""Saved-observation equivalence and bounded-history failures. README_VIEWPORT_LEDGER_V2.md."""
...
from viewport_ledger_v2 import ViewportLedger, encoded, expand_summary, read_row
...
class LedgerTests(unittest.TestCase):
    ...
    def test_large_span_history_keeps_no_caption_copies_in_metadata(self):
        ...
        self.assertLessEqual((ledger.directory/'SUMMARY.json').stat().st_size, 8*1024**2)
        self.assertEqual(load(ledger.directory/'SUMMARY.json'), summary)
        ...
        CONTEXT['large_history'] = dict(summary=bind(ledger.directory/'SUMMARY.json'),
            ...
            actual_summary_file_bytes=(ledger.directory/'SUMMARY.json').stat().st_size,
