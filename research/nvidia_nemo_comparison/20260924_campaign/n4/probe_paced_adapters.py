"""Bounded saved-vector and source-clock qualification. README_PACED_ADAPTERS.md."""
import argparse
...
def run(args):
    ...
    code = [bind(here/n) for n in ('paced_adapters.py', 'test_paced_adapters.py', 'probe_paced_adapters.py',
        'README_PACED_ADAPTERS.md', 'mode_galleries.py', 'controller_projection.py', 'common.py',
    ...
    import test_paced_adapters as tests
