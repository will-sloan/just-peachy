"""Dictionary-only rejection tests. See README_SCORING_CLOCK_V2.md."""
from copy import deepcopy
import unittest

from common import fingerprint
from metric_process import pin
from review_scoring_bank_v2 import (edit_counts, owners_closed, validate_activity, validate_row,
