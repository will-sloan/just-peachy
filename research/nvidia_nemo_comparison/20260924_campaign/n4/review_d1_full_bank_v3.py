"""Review all full-bank D1 cells. See README_D1_FRAME_CLOCK_V3.md."""
import argparse
import gzip
import json
...
OWN=('review_d1_frame_clock_v3.py','review_d1_full_bank_v3.py','test_d1_frame_clock_v3.py','test_review_d1_full_bank_v3.py','README_D1_FRAME_CLOCK_V3.md')

def code_bindings():
    here=Path(__file__).resolve().parent
    return [bind(here/n) for n in OWN+('review_d1_components.py','review_d1_full_bank.py','test_review_d1_components.py','test_review_d1_full_bank.py','test_d1_lane_components.py','review_d1_frame_clock_v2.py','review_d1_full_bank_v2.py','test_d1_frame_clock_v2.py','test_review_d1_full_bank_v2.py','README_D1_FRAME_CLOCK_V2.md')]
