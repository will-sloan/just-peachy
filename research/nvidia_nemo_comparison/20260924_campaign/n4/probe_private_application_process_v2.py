...
import test_private_application_process_v2 as regression
...
def run(output):
    ...
    with writer_lock(local/'n4/metric-scoring.owner.lock'):
        ...
        code = [bind(here/name) for name in ('private_application_process_v2.py', 'private_process_fixture_v2.py',
            'test_private_application_process_v2.py', 'probe_private_application_process_v2.py', 'README_PRIVATE_APPLICATION_PROCESS_V2.md',
