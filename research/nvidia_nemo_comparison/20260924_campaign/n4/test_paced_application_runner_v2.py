...
import paced_application_runner_v2 as runner
...
class RunnerTests(unittest.TestCase):
    ...
    def test_collection_releases_after_verified_cleanup(self):
        with tempfile.TemporaryDirectory() as temp:
            ...
            self.assertEqual(events,['acquire','spawn','register','lease','resume','close','native_envelope','release'])
    ...
    def test_missing_production_plan_is_not_admitted(self):
        with tempfile.TemporaryDirectory() as temp:
            ...
            with patch('paced_panel_plan_v2.reconstruct') as review,self.assertRaises(FileNotFoundError):runner.admit_plan(path)
