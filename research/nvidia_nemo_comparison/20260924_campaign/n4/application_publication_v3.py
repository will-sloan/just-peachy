"""Actual application publication methods under a modeled clock. README_INTEGRATED_HISTORY_V3.md."""
...
from component_d1_replay_v2 import d1_plan,QueryJournal,CooperativeActivity
...
class PublicationInbox:
    ...
    def put(self,event):
        ...
        if len(self.rows)>=100000 or self.bytes>64*1024**2:raise ValueError('Publication trace budget exceeded')
