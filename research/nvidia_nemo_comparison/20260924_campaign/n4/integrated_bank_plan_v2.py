"""Exact reviewed-component join for N4. See README_INTEGRATED_BANK_CLOCK_V2.md."""
...
def code_bindings():
    names=('integrated_bank_plan.py','integrated_bank.py','test_integrated_bank.py','README_INTEGRATED_BANK.md',
        'application_publication.py','controller_projection_v2.py','controller_projection.py',
        'component_commands.py','component_d1_replay.py','component_s7_replay.py','component_presentation.py',
        'mode_galleries.py','probe_component_s7.py','probe_controller_projection.py','common.py',
        'evidence_store.py','evidence_archive.py','evidence_reader.py','compose_release_v3.py',
        'asr_full_bank.py','asr_bank_components.py','d0_bank_components.py','d1_full_bank.py','d1_bank_components.py')
    from review_d1_full_bank_v3 import code_bindings as clock_code
    extra=('method_artifact_v2.py','component_d1_replay_v2.py','application_publication_v2.py','integrated_bank_plan_v2.py','integrated_bank_v2.py','test_integrated_bank_v2.py','README_INTEGRATED_BANK_CLOCK_V2.md')
    registry={b['path']:b for b in [*[bind(HERE/n) for n in names+extra],bind(HERE.parent/'supervision/supervisor.py'),*clock_code()]}
...
def prepare(args):
    qualification=load(HERE/'INTEGRATED_BANK_CLOCK_CHECK_V2.json')
    if qualification['status']!='PASS_INTEGRATED_BANK_NATIVE_CLOCK_DERIVATIVE_ONLY' or qualification['code']!=code_bindings():
    ...
    context=dict(source_receipt=source,gallery_preparation=gallery,catalog=galleries['catalog'],manifest=manifest,panel=panel,
        reviews=reviews,runtimes=runtimes,qualification=[bind(HERE/'APPLICATION_PUBLICATION_CHECK_V1.json'),bind(HERE/'EMPTY_CONTROLLER_CHECK_V1.json'),bind(HERE/'INTEGRATED_BANK_CLOCK_CHECK_V2.json')],
        code=code_bindings())
