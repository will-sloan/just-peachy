"""Launch viewport tests only on a private desktop. README_WIDGET_VISIBILITY.md."""
import argparse
...
MODULE='research.nvidia_nemo_comparison.20260924_campaign.n4.test_widget_visibility'
...
def run(args):
    ...
    code=[bind(here/n) for n in ('widget_visibility.py','test_widget_visibility.py','probe_widget_visibility.py',
        'README_WIDGET_VISIBILITY.md','integrated_scoring_adapter.py','common.py')]
