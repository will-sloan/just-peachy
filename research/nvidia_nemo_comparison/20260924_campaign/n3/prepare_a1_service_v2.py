...
def main():
    ...
    jobs=[dict(id='A1-service-export',argv=[argv[0],'-B',str(here/'export_a1_service_v2.py'),*common,'--output',str(bundle)],
        ...
        dict(id='A1-service-parity',argv=[argv[0],'-B',str(here/'check_a1_service_v2.py'),*common,'--bundle',str(bundle),
    ...
    for p in [args.parent_plan,worker,*[here/n for n in ('prepare_a1_service_v2.py','export_a1_service_v2.py','check_a1_service_v2.py','a1_onnx_v2.py','test_a1_onnx_v2.py','a1_export_contract.py','test_a1_export_contract.py','diagnose_a1_parity.py')]]:
