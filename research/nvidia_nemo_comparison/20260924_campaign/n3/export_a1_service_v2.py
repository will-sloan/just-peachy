...
def main():
    ...
    try:
        ...
        model=service.asr_model;configure_service_export(service)
        ...
        if result['streaming_after_export']!=config['streaming']:raise ValueError('Graph export changed service geometry')
